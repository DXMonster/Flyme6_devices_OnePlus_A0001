.class public final Lcom/android/lineageos/CredentialStorage;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/lineageos/CredentialStorage$ResetDialog;,
        Lcom/android/lineageos/CredentialStorage$ResetKeyStoreAndKeyChain;,
        Lcom/android/lineageos/CredentialStorage$ConfigureKeyGuardDialog;,
        Lcom/android/lineageos/CredentialStorage$UnlockDialog;
    }
.end annotation
...
.method static synthetic -get0()[I
    ...
    sget-object v0, Lcom/android/lineageos/CredentialStorage;->SYSTEM_CREDENTIAL_UIDS:[I

    return-object v0
.end method

.method static synthetic -get1(Lcom/android/lineageos/CredentialStorage;)Landroid/security/KeyStore;
    .locals 1

    iget-object v0, p0, Lcom/android/lineageos/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;

    return-object v0
.end method

.method static synthetic -get2(Lcom/android/lineageos/CredentialStorage;)I
    .locals 1

    iget v0, p0, Lcom/android/lineageos/CredentialStorage;->mRetriesRemaining:I
...
.method private static synthetic -getandroid_security_KeyStore$StateSwitchesValues()[I
    ...
    sget-object v0, Lcom/android/lineageos/CredentialStorage;->-android_security_KeyStore$StateSwitchesValues:[I
    ...
    :goto_2
    sput-object v0, Lcom/android/lineageos/CredentialStorage;->-android_security_KeyStore$StateSwitchesValues:[I
...
.method static synthetic -set0(Lcom/android/lineageos/CredentialStorage;I)I
    .locals 0

    iput p1, p0, Lcom/android/lineageos/CredentialStorage;->mRetriesRemaining:I

    return p1
.end method

.method static synthetic -wrap0(Lcom/android/lineageos/CredentialStorage;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/lineageos/CredentialStorage;->ensureKeyGuard()V

    return-void
.end method

.method static synthetic -wrap1(Lcom/android/lineageos/CredentialStorage;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/lineageos/CredentialStorage;->handleUnlockOrInstall()V
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/lineageos/CredentialStorage;->SYSTEM_CREDENTIAL_UIDS:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/lineageos/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;

    .line 125
    const/4 v0, -0x1

    iput v0, p0, Lcom/android/lineageos/CredentialStorage;->mRetriesRemaining:I
...
.method private checkCallerIsCertInstallerOrSelfInProfile()Z
    ...
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->getCallingPackage()Ljava/lang/String;
    ...
    .line 423
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->getPackageName()Ljava/lang/String;
    ...
    .line 430
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->getActivityToken()Landroid/os/IBinder;
    ...
    invoke-virtual {p0, v7}, Lcom/android/lineageos/CredentialStorage;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method private confirmKeyGuard()Z
    ...
    .line 458
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->getResources()Landroid/content/res/Resources;
    ...
    invoke-direct {v2, p0}, Lcom/android/lineageos/ChooseLockSettingsHelper;-><init>(Landroid/app/Activity;)V
    ...
    .line 459
    invoke-virtual {v2, v4, v3, v4}, Lcom/android/lineageos/ChooseLockSettingsHelper;->launchConfirmationActivity(ILjava/lang/CharSequence;Z)Z
...
.method private ensureKeyGuard()V
    ...
    .prologue
    .line 192
    invoke-direct {p0}, Lcom/android/lineageos/CredentialStorage;->checkKeyGuardQuality()Z
    ...
    .line 194
    new-instance v0, Lcom/android/lineageos/CredentialStorage$ConfigureKeyGuardDialog;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/lineageos/CredentialStorage$ConfigureKeyGuardDialog;-><init>(Lcom/android/lineageos/CredentialStorage;Lcom/android/lineageos/CredentialStorage$ConfigureKeyGuardDialog;)V
    ...
    .line 199
    :cond_0
    invoke-direct {p0}, Lcom/android/lineageos/CredentialStorage;->confirmKeyGuard()Z
    ...
    .line 203
    :cond_1
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->finish()V
...
.method private handleUnlockOrInstall()V
    ...
    .line 161
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->isFinishing()Z
    ...
    .line 164
    :cond_0
    invoke-static {}, Lcom/android/lineageos/CredentialStorage;->-getandroid_security_KeyStore$StateSwitchesValues()[I

    move-result-object v0

    iget-object v1, p0, Lcom/android/lineageos/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;
    ...
    .line 170
    :pswitch_1
    new-instance v0, Lcom/android/lineageos/CredentialStorage$UnlockDialog;

    invoke-direct {v0, p0, v2}, Lcom/android/lineageos/CredentialStorage$UnlockDialog;-><init>(Lcom/android/lineageos/CredentialStorage;Lcom/android/lineageos/CredentialStorage$UnlockDialog;)V
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/lineageos/CredentialStorage$ConfigureKeyGuardDialog;-><init>(Lcom/android/lineageos/CredentialStorage;Lcom/android/lineageos/CredentialStorage$ConfigureKeyGuardDialog;)V
    ...
    .line 178
    :cond_1
    invoke-direct {p0}, Lcom/android/lineageos/CredentialStorage;->installIfAvailable()V
...
.method private installIfAvailable()V
    ...
    .prologue
    .line 234
    iget-object v12, p0, Lcom/android/lineageos/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;
    ...
    .line 238
    :cond_1
    iget-object v0, p0, Lcom/android/lineageos/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;

    .line 239
    .local v0, "bundle":Landroid/os/Bundle;
    const/4 v12, 0x0

    iput-object v12, p0, Lcom/android/lineageos/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;
    ...
    invoke-direct {p0, v11}, Lcom/android/lineageos/CredentialStorage;->isHardwareBackedKey([B)Z
    ...
    .line 273
    :cond_3
    iget-object v12, p0, Lcom/android/lineageos/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;
    ...
    invoke-virtual {p0, v7, v12}, Lcom/android/lineageos/CredentialStorage;->startActivityAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    invoke-virtual {p0, v12}, Lcom/android/lineageos/CredentialStorage;->setResult(I)V
...
.method protected onResume()V
    ...
    .line 131
    invoke-virtual {p0}, Lcom/android/lineageos/CredentialStorage;->getIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v3}, Lcom/android/lineageos/CredentialStorage;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 136
    new-instance v3, Lcom/android/lineageos/CredentialStorage$ResetDialog;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lcom/android/lineageos/CredentialStorage$ResetDialog;-><init>(Lcom/android/lineageos/CredentialStorage;Lcom/android/lineageos/CredentialStorage$ResetDialog;)V
    ...
    invoke-direct {p0}, Lcom/android/lineageos/CredentialStorage;->checkCallerIsCertInstallerOrSelfInProfile()Z
    ...
    iput-object v3, p0, Lcom/android/lineageos/CredentialStorage;->mInstallBundle:Landroid/os/Bundle;
    ...
    iget-object v3, p0, Lcom/android/lineageos/CredentialStorage;->mKeyStore:Landroid/security/KeyStore;
