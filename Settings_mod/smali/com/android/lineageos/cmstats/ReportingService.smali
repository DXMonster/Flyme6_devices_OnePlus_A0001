.class public Lcom/android/lineageos/cmstats/ReportingService;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/lineageos/cmstats/ReportingService;->DEBUG:Z
...
.method public constructor <init>()V
    ...
    .prologue
    .line 38
    const-class v0, Lcom/android/lineageos/cmstats/ReportingService;
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/lineageos/cmstats/ReportingService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/android/lineageos/cmstats/ReportingService;->getApplicationContext()Landroid/content/Context;

    move-result-object v9

    invoke-static {v9}, Lcom/android/lineageos/cmstats/Utilities;->getUniqueID(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v5

    .line 46
    .local v5, "deviceId":Ljava/lang/String;
    invoke-static {}, Lcom/android/lineageos/cmstats/Utilities;->getDevice()Ljava/lang/String;

    move-result-object v6

    .line 47
    .local v6, "deviceName":Ljava/lang/String;
    invoke-static {}, Lcom/android/lineageos/cmstats/Utilities;->getModVersion()Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/android/lineageos/cmstats/Utilities;->getCountryCode(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/android/lineageos/cmstats/Utilities;->getCarrier(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/android/lineageos/cmstats/Utilities;->getCarrierId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v9}, Lcom/android/lineageos/cmstats/AnonymousStats;->getNextJobId(Landroid/content/Context;)I

    move-result v1

    .line 54
    .local v1, "cmOrgJobId":I
    sget-boolean v9, Lcom/android/lineageos/cmstats/ReportingService;->DEBUG:Z
    ...
    invoke-virtual {p0}, Lcom/android/lineageos/cmstats/ReportingService;->getPackageName()Ljava/lang/String;

    move-result-object v11

    .line 71
    const-class v12, Lcom/android/lineageos/cmstats/StatsUploadJobService;
    ...
    .line 79
    invoke-static {p0}, Lcom/android/lineageos/cmstats/AnonymousStats;->updateLastSynced(Landroid/content/Context;)V

    .line 80
    invoke-static {p0}, Lcom/android/lineageos/cmstats/ReportingServiceManager;->setAlarm(Landroid/content/Context;)V
