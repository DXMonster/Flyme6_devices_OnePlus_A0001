.class public final Lcom/android/lineageos/Utils;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/lineageos/Utils;->BADNESS_COLORS:[I
    ...
    sput-object v0, Lcom/android/lineageos/Utils;->sDarkDefaultUserBitmapCache:Landroid/util/SparseArray;
...
.method public static buildGlobalChangeWarningDialog(Landroid/content/Context;ILjava/lang/Runnable;)Landroid/app/Dialog;
    ...
    .line 711
    new-instance v1, Lcom/android/lineageos/Utils$1;

    invoke-direct {v1, p2}, Lcom/android/lineageos/Utils$1;-><init>(Ljava/lang/Runnable;)V
...
.method public static createUserAdapter(Landroid/os/UserManager;Landroid/content/Context;Ljava/util/List;)Lcom/android/lineageos/UserAdapter;
    .locals 5
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ">;)",
            "Lcom/android/lineageos/UserAdapter;"
        }
    .end annotation
    ...
    .line 939
    .local v2, "userDetails":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/lineageos/UserAdapter$UserDetails;>;"
    invoke-interface {p2}, Ljava/util/List;->size()I
    ...
    .line 941
    new-instance v4, Lcom/android/lineageos/UserAdapter$UserDetails;
    ...
    invoke-direct {v4, v3, p0, p1}, Lcom/android/lineageos/UserAdapter$UserDetails;-><init>(Landroid/os/UserHandle;Landroid/os/UserManager;Landroid/content/Context;)V
    ...
    .line 943
    :cond_0
    new-instance v3, Lcom/android/lineageos/UserAdapter;

    invoke-direct {v3, p1, v2}, Lcom/android/lineageos/UserAdapter;-><init>(Landroid/content/Context;Ljava/util/ArrayList;)V

    return-object v3
.end method

.method public static createUserSpinnerAdapter(Landroid/os/UserManager;Landroid/content/Context;)Lcom/android/lineageos/UserAdapter;
    .locals 4
    .param p0, "userManager"    # Landroid/os/UserManager;
    .param p1, "context"    # Landroid/content/Context;
    ...
    .line 933
    invoke-static {p0, p1, v1}, Lcom/android/lineageos/Utils;->createUserAdapter(Landroid/os/UserManager;Landroid/content/Context;Ljava/util/List;)Lcom/android/lineageos/UserAdapter;
...
.method public static forcePrepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/widget/ListView;Z)V
    ...
    .line 570
    invoke-static {p0, p1, p2, p3}, Lcom/android/lineageos/Utils;->prepareCustomPreferencesList(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;Z)V
...
.method public static formatPercentage(I)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/android/lineageos/Utils;->formatPercentage(D)Ljava/lang/String;
...
.method public static getBatteryPercentage(Landroid/content/Intent;)Ljava/lang/String;
    ...
    .prologue
    .line 481
    invoke-static {p0}, Lcom/android/lineageos/Utils;->getBatteryLevel(Landroid/content/Intent;)I

    move-result v0

    invoke-static {v0}, Lcom/android/lineageos/Utils;->formatPercentage(I)Ljava/lang/String;
...
.method public static getDefaultIpAddresses(Landroid/net/ConnectivityManager;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/android/lineageos/Utils;->formatIpAddresses(Landroid/net/LinkProperties;)Ljava/lang/String;
...
.method public static getDefaultUserIconAsBitmap(I)Landroid/graphics/Bitmap;
    ...
    sget-object v1, Lcom/android/lineageos/Utils;->sDarkDefaultUserBitmapCache:Landroid/util/SparseArray;
...
.method public static getLaunchByDeafaultSummary(Lcom/android/lineageoslib/applications/ApplicationsState$AppEntry;Landroid/hardware/usb/IUsbManager;Landroid/content/pm/PackageManager;Landroid/content/Context;)Ljava/lang/CharSequence;
    .locals 5
    ...
    .prologue
    .line 1262
    iget-object v4, p0, Lcom/android/lineageoslib/applications/ApplicationsState$AppEntry;->info:Landroid/content/pm/ApplicationInfo;

    iget-object v2, v4, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    .line 1263
    .local v2, "packageName":Ljava/lang/String;
    invoke-static {p2, v2}, Lcom/android/lineageos/Utils;->hasPreferredActivities(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    .line 1264
    invoke-static {p1, v2}, Lcom/android/lineageos/Utils;->hasUsbDefaults(Landroid/hardware/usb/IUsbManager;Ljava/lang/String;)Z
...
.method public static getMeProfileName(Landroid/content/Context;Z)Ljava/lang/String;
    ...
    .line 633
    invoke-static {p0}, Lcom/android/lineageos/Utils;->getProfileDisplayName(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 635
    :cond_0
    invoke-static {p0}, Lcom/android/lineageos/Utils;->getShorterNameIfPossible(Landroid/content/Context;)Ljava/lang/String;
...
.method public static getSecureTargetUser(Landroid/os/IBinder;Landroid/os/UserManager;Landroid/os/Bundle;Landroid/os/Bundle;)Landroid/os/UserHandle;
    ...
    :cond_3
    invoke-static {p1, v7}, Lcom/android/lineageos/Utils;->isProfileOf(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    ...
    invoke-static {p1, v4}, Lcom/android/lineageos/Utils;->isProfileOf(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    ...
    invoke-static {p1, v1}, Lcom/android/lineageos/Utils;->isProfileOf(Landroid/os/UserManager;Landroid/os/UserHandle;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static getShorterNameIfPossible(Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 640
    invoke-static {p0}, Lcom/android/lineageos/Utils;->getLocalProfileGivenName(Landroid/content/Context;)Ljava/lang/String;
...
.method private static getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;
    ...
    invoke-static {v1}, Lcom/android/lineageos/Utils;->getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
    :try_end_0
...
.method public static getWifiIpAddresses(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/lineageos/Utils;->formatIpAddresses(Landroid/net/LinkProperties;)Ljava/lang/String;
...
.method public static handleLoadingContainer(Landroid/view/View;Landroid/view/View;ZZ)V
    ...
    :goto_0
    invoke-static {p0, v0, p3}, Lcom/android/lineageos/Utils;->setViewShown(Landroid/view/View;ZZ)V

    .line 1277
    invoke-static {p1, p2, p3}, Lcom/android/lineageos/Utils;->setViewShown(Landroid/view/View;ZZ)V
...
.method public static isSystemPackage(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
    ...
    .line 1080
    sget-object v1, Lcom/android/lineageos/Utils;->sSystemSignature:[Landroid/content/pm/Signature;
    ...
    invoke-static {p0}, Lcom/android/lineageos/Utils;->getSystemSignature(Landroid/content/pm/PackageManager;)Landroid/content/pm/Signature;

    move-result-object v2

    aput-object v2, v1, v0

    sput-object v1, Lcom/android/lineageos/Utils;->sSystemSignature:[Landroid/content/pm/Signature;
    ...
    invoke-static {p1}, Lcom/android/lineageos/Utils;->getFirstSignature(Landroid/content/pm/PackageInfo;)Landroid/content/pm/Signature;
...
.method public static onBuildStartFragmentIntent(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ILjava/lang/CharSequence;Z)Landroid/content/Intent;
    ...
    .line 868
    const-class v1, Lcom/android/lineageos/SubSettings$BluetoothSubSettings;
    ...
    .line 871
    const-class v1, Lcom/android/lineageos/SubSettings$SecuritySubSettings;
    ...
    .line 874
    :cond_1
    const-class v1, Lcom/android/lineageos/SubSettings;
...
.method private static setViewShown(Landroid/view/View;ZZ)V
    ...
    :cond_1
    new-instance v1, Lcom/android/lineageos/Utils$2;

    invoke-direct {v1, p0}, Lcom/android/lineageos/Utils$2;-><init>(Landroid/view/View;)V
...
.method public static startWithFragment(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;IILjava/lang/CharSequence;)V
    ...
    .line 776
    invoke-static/range {v0 .. v8}, Lcom/android/lineageos/Utils;->startWithFragment(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/Fragment;ILjava/lang/String;ILjava/lang/CharSequence;Z)V
...
.method public static updatePreferenceToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Landroid/preference/PreferenceGroup;Ljava/lang/String;)Z
    ...
    .line 270
    instance-of v0, v11, Lcom/android/lineageos/IconPreferenceScreen;
    ...
    .line 292
    check-cast v5, Lcom/android/lineageos/IconPreferenceScreen;

    .line 293
    .local v5, "iconPreference":Lcom/android/lineageos/IconPreferenceScreen;
    invoke-virtual {v5, v4}, Lcom/android/lineageos/IconPreferenceScreen;->setIcon(Landroid/graphics/drawable/Drawable;)V

    .line 297
    .end local v5    # "iconPreference":Lcom/android/lineageos/IconPreferenceScreen;
    :cond_4
...
.method public static updateTileToSpecificActivityFromMetaDataOrRemove(Landroid/content/Context;Lcom/android/lineageos/dashboard/DashboardTile;)Z
    .locals 16
    .param p0, "context"    # Landroid/content/Context;
    ...
    iget-object v4, v0, Lcom/android/lineageos/dashboard/DashboardTile;->intent:Landroid/content/Intent;
    ...
    iget-object v13, v0, Lcom/android/lineageos/dashboard/DashboardTile;->userHandle:Ljava/util/ArrayList;
    ...
    iput v3, v0, Lcom/android/lineageos/dashboard/DashboardTile;->iconRes:I
    ...
    iput-object v13, v0, Lcom/android/lineageos/dashboard/DashboardTile;->iconPkg:Ljava/lang/String;

    .line 368
    :cond_5
    move-object/from16 v0, p1

    iput-object v12, v0, Lcom/android/lineageos/dashboard/DashboardTile;->title:Ljava/lang/CharSequence;

    .line 369
    move-object/from16 v0, p1

    iput-object v11, v0, Lcom/android/lineageos/dashboard/DashboardTile;->summary:Ljava/lang/CharSequence;
    ...
    iput-object v13, v0, Lcom/android/lineageos/dashboard/DashboardTile;->intent:Landroid/content/Intent;
